...
ldef.define('keyword', 'constant as memory storage'.split(' '));
...
pdef.define('import', [ 'keyword:import', 'operator:*', 'keyword:as', 'name:', 'name:from', 'string:', 'delimiter:;' ], function (values) { return geast.import(values[5], values[3]); });
