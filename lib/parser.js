...
geast.node('method', [ 'name', 'type', 'visibility', 'arguments', 'body', 'mutability' ]);
...
// methods
pdef.define('method', [ 'name:function', 'name:', 'delimiter:(', 'arglist', 'delimiter:)', '?visibility', '?state-mutability', '?returns', 'command' ], function (values) { return geast.method(values[1], values[7], values[5], values[3], values[8], values[6]); });
...
pdef.define('visibility', 'name:external');
