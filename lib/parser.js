...
geast.node('method', [ 'name', 'type', 'visibility', 'arguments', 'body', 'payable' ]);
...
// methods
pdef.define('method', [ 'name:function', 'name:', 'delimiter:(', 'arglist', 'delimiter:)', '?visibility', '?payable', '?returns', 'command' ], function (values) { return geast.method(values[1], values[7], values[5], values[3], values[8], values[6] ? true : null); });
pdef.define('returns', [ 'name:returns', 'delimiter:(', 'type', 'delimiter:)' ], function (values) { return values[2]; });
pdef.define('payable', 'name:payable');
