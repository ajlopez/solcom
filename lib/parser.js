...
pdef.define('topdecl', 'method');
pdef.define('topdecl', 'constantdecl');

// enum
pdef.define('enum', [ 'name:enum', 'name:', 'delimiter:{', 'valuelist', 'delimiter:}' ], function (values) { return geast.enum(values[1], values[3]); });
...
// struct
pdef.define('struct', [ 'name:struct', 'name:', 'delimiter:{', 'memberlist', 'delimiter:}' ], function (values) { return geast.struct(values[1], values[3]); });
