...
geast.node('method', [ 'name', 'type', 'arguments', 'body', 'modifiers' ]);
...
pdef.define('function-modifiers', [ 'state-mutability', 'function-modifiers' ], function(values) { values[1].mutability = values[0]; return values[1]; });
pdef.define('function-modifiers', [ 'visibility', 'function-modifiers' ], function(values) { values[1].visibility = values[0]; return values[1]; });
pdef.define('function-modifiers', [ '!', 'name:returns' ], function() { return {}; });
pdef.define('function-modifiers', [ '!', 'delimiter:{' ], function() { return {}; });
pdef.define('function-modifiers', [ '!', 'delimiter:;' ], function() { return {}; });
