...
// methods
pdef.define('method', [ 'name:function', 'name:', 'delimiter:(', 'arglist', 'delimiter:)', 'command' ], function (values) { return geast.method(values[1], 'void', null, values[3], values[5]); });
pdef.define('method', [ 'name:function', 'name:', 'delimiter:(', 'arglist', 'delimiter:)', 'visibility', 'command' ], function (values) { return geast.method(values[1], 'void', values[5], values[3], values[6]); });
pdef.define('method', [ 'name:function', 'name:', 'delimiter:(', 'arglist', 'delimiter:)', 'name:returns', 'delimiter:(', 'type', 'delimiter:)', 'command' ], function (values) { return geast.method(values[1], values[6], null, values[3], values[9]); });
pdef.define('method', [ 'name:function', 'name:', 'delimiter:(', 'arglist', 'delimiter:)', 'visibility', 'name:returns', 'delimiter:(', 'type', 'delimiter:)','command' ], function (values) { return geast.method(values[1], values[8], values[5], values[3], values[10]); });
