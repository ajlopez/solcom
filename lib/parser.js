...
// modifier
pdef.define('modifier', [ 'name:modifier', 'name:', 'delimiter:(', 'arglist', 'delimiter:)','delimiter:{', 'delimiter:}' ], function (values) { return geast.modifier(values[1], values[3], geast.sequence([])); }); 
